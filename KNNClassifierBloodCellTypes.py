## test out K nearest neighbours classifier to predict cell type based on subset of CpGs
...
np.savetxt(resultsPath + "KNNFilteredChr" + str(chr) + ".csv", results, delimiter=",")