## uses random forest algorithm to classify cell type based on subset of CpGs
...
np.savetxt(resultsPath + "RandomForestFilteredChr" + str(chr) + ".csv", results, delimiter=",")